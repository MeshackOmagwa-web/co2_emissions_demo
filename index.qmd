...
emissions_long_subset = emissions_long_1990_2022.query("country in ['Kenya', 'Germany', 'USA', 'Egypt', 'China']")

# Create line chart. Year should be on the x-axis, emissions on the y-axis, and color should be by country.
fig_chart = px.line(emissions_long_subset, x="year", y="emissions", color="country", title="Distribution of CO2 emissions per country from 1990 to 2021", color_discrete_sequence=['#1165ed', '#97f00a', '#0be0d2', '#e32b17', '#f10cf5'])
